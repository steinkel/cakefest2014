...
<div class="questions index">
	...
	<tr>
		...
		<th><?= $this->Paginator->sort('preferences') ?></th>
	...
	<tr>
		<td><?= h($question->id) ?>&nbsp;</td>
		<td>
			<?= $question->has('user') ? $this->Html->link($question->user->full_name, ['controller' => 'Users', 'action' => 'view', $question->user->id]) : '' ?>
		</td>
